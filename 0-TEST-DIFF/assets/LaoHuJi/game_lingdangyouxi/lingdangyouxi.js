var zhuanpan = require("zhuanpan2");
var StateMachine = require("stateMachine");
var lingdangyouxi_socket = require('../module/SocketIO/game_socket');
var Global = null;
cc.Class({
    ...
    start: function () {
        ...
        this.url=Lhjconfig.Server_IP+Lhjconfig.lingdangyouxi_Port;
        lingdangyouxi_socket.socket_Inin(this.url,'lingdangyouxi',Global);                      //连接铃铛游戏服务器
        lingdangyouxi_socket.Nowcanvas=this;
        ...
        this.node.on('Event_StateChange', function (event) {
            ...
            switch (event.detail) {
                ...
                case 1:
                    ...
                    lingdangyouxi_socket.reqBet('lottery',JSON.stringify({nBetList:now__intArrayXiaZhu}));
                ...
                case 3:
                    ...
                    if (self._winCoin > 0) {
                        ...
                        cc.loader.loadRes("WinCoins", function (err, prefab) {
                            ...
                            var x = vector.x;
                            vector.x = vector.y;vector.y = -x;//补丁：旋转一下vector，因为这款游戏的Canvas旋转了
    ...
    onBtnClick_xiazhu_all: function () { //全部+1
        for (var i = 0; i < this._itemArrayLength; i++) {
