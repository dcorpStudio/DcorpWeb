...
cc.Class({
    ...
    startRoll(...args) {
        ...
        setTimeout(() => {
            ...
            this.node.runAction(
                cc.sequence(
                    cc.delayTime(0.2),
                    cc.moveTo(timer, cc.v2(this.node.x, -this.node.height + 460)),
                    cc.moveTo(0.1, cc.v2(this.node.x, -this.node.height + 498)),
                    cc.moveTo(0.1, cc.v2(this.node.x, -this.node.height + 460)),
    ...
    stopImmediately() {
        ...
        setTimeout(() => {
            this.node.y = -this.node.height + 460;
        }, 50);
        this.status = 0;
        this.mainObj.stateCallBack();
    },
