...
<%function Admin_Status_Format(x){
	return '<b style="color:#039bdc; font-size:14px;">' + x + '</b><br><br>'
}%>
...
<style>
	...
	.Form_Button {border:1px solid #000;}
</style>



<%Session('Page_After_Delete') = (new thisPage_URL()).URL%>
