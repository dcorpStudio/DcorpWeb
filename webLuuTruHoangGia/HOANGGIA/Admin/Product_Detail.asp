			...
			<table width="100%" cellpadding=0 cellspacing=0>
				<tr>
					<td valign=top style="padding:10">
						...
						<!--IMAGE COMPONENT-->
							<table border="0" cellspacing="0" cellpadding="0" align=left style="margin-right:10; margin-bottom:10;">
								<tr><td>
						...
						<p style="line-height:1.8">
							...
							<b><u>Giá bán</u></b> : <b style="color:#900;"> <%=Format_Price(DB.RS('Price'))%> </b> <br>
						</p>
...
<script>
	function update_prod(ID){	window.location = 'Product_Edit.asp?Mode=Update&ID='+ID	}
	function del_prod(ID){ if (confirm('Bạn muốn xóa sản phẩm ?')){ window.location = 'Del.asp?Table_name=Product&ID='+ID } }
</script>
