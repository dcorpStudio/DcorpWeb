...
function Global_Var(Name){
	var Site_Path = "/HOANGGIA"
	var Site_Url = 'http://luutruhoanggia.com'
	...
	switch (String(Name).toLowerCase()){
		...
		case 'default_email' : return 'Info@batdongsannhv.com'; break;

		case "admin_email" : return "Daphongcach@Gmail.com"; break;
		...
		//----------So lan lam moi tin rao cua thanh vien trong 1 ngay
		case 'Renew_Time_Per_Day' : return 3; break;
	}
}
%>
