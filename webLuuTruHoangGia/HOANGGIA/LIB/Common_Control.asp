...
/////////////////////////////////////////////// CONTROL  FAMILY
	...
	function Control_Textbox(Name, Data_Type , Data_Field, Max_val, Min_Val){
		...
		//---Output_function
		this.Output = function(){ if (this.Style===undefined){	this.Style = ' style="width:'+this.Width+'px;border:1px solid #999999;" ' }
	...
	function Control_Textarea(Name, Data_Type , Data_Field, Max_val, Min_Val){
		...
		//----Output function
		this.Output = function(){ if (this.Style===undefined){	this.Style = ' style="width:'+this.Width+'px;height:'+this.Height+'px;border:1px solid #999999;" ' }
	...
	function Control_Checkbox(Name, Data_Type , Data_Field, Max_val, Min_Val){
		...
		this.Output = function(){
			...
			//----Style
			if (this.Style===undefined){	this.Style = ' style="width:'+this.Width+'px;border:1px solid #999999;" ' }
			return this.Body;
		}
	}
...
/////////////////////////////////////////////// CONTROL COLLECTION Object
	...
	function Control_Collection (Mode, Control_Arr){
		...
		this.Output = function(Intro_Arr){
			...
			Code +='\n<br><br><input type="submit" value="OK" class="Form_Button" style="width:100px;height:24px;"> &nbsp; '
//			Code +='\n<input type="button" value="Cancel" class="Form_Button" style="width:100px;height:24px;" onclick="window.location=\''+this.Refer_Page+'\'">'
			Code +='\n<input type="button" value="Cancel" class="Form_Button" style="width:100px;height:24px;" onclick="history.back(-1)">'
			Code +='\n</form>\n'
			Code +='<'+'!--//form code--'+'>\n'
			return Code;	}
	}
